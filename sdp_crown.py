...
def verified_sdp_crown(dataset, labels, model, radius, clean_output, device, classes, args, batch_size=2, return_robust_points=False, x_U=None, x_L=None, groupsort=False):
    """
    Args:
